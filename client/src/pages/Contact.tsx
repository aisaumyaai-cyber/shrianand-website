      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2">
            <h1 className="text-4xl font-bold font-heading mb-6 text-[#43444ae3]">Get in Touch</h1>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg text-[#43444ae3] mb-1">Phone & WhatsApp</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg text-[#43444ae3] mb-1">Clinic Hours</h3>
              ...
              <CardContent className="p-8">
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    />
                    <Button type="submit" className="w-full h-12 text-lg">Book Appointment</Button>
                  </form>
                </Form>
              </CardContent>
            </Card>
